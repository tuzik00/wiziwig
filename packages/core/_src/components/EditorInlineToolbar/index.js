...
import './EditorInlineToolbar.styl';
...
const EditorInlineToolbar = (props) => {
    const {
        editorState,
        onAdd = () => {
        },
    ...
    const [seveNode, setNode] = useState(null);
    ...
    const findNode = useCallback(() => {
        ...
        setNode(node);
        setVisible(true);
        setTop(node.offsetTop - 8)
    }, [seveNode, editorState]);
    ...
    }, [editorState, blockType, blockKey, isVisible, isShow]);
        ...
        >
            ...
            <div className={cn(`${EditorInlineToolbar.displayName}__menu`, {
                ...
                <button
                    className={`${EditorInlineToolbar.displayName}__menu-btn`}
                    onClick={() => {
                        const entityKey = Entity.create('blockCard', 'IMMUTABLE', {
                            list: [1, 2, 3, 4, 5]
                        });
...
EditorInlineToolbar.displayName = 'EditorInlineToolbar';


export default EditorInlineToolbar;